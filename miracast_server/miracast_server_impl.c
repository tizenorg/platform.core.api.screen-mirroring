		...
		gchar *filesrc)
{
	...
	if (gst_rtsp_wfd_server_set_direct_streaming(server, direct_streaming, filesrc) != ERROR_NONE) {
		scmirroring_error("Failed to set direct streaming to server object");
		goto failed;
	}
